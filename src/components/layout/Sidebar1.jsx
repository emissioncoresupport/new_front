      ...
      <div className="mb-2 group">
        <button
          ...
          <div className={cn("flex items-center", collapsed ? "" : "gap-2.5")}>
            ...
            {!collapsed && <span className={cn("tracking-wider font-light", isSection ? "text-xs uppercase text-slate-300" : "text-sm text-slate-300", isActive ? "text-[#86b027] font-medium" : "")}>{label}</span>}
          </div>
...
export default function Sidebar() {
  ...
  console.log("authhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh")
  ...
  useEffect(() => {
    ...
    //console.log("menuuuuuuuuuuuuuuuuuuuuuuu");
  ...
  return (
    <div className={cn(
      "bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 h-screen flex flex-col border-r border-white/10 flex-shrink-0 text-white shadow-2xl backdrop-blur-xl relative z-50 transition-all duration-300",
      collapsed ? "w-20" : "w-72"
    )}>
      {/* Logo Area */}
      <div className={cn(
        "border-b border-white/10 relative overflow-hidden group bg-gradient-to-b from-slate-950/50 to-transparent backdrop-blur-md transition-all duration-300",
        collapsed ? "px-3 py-6" : "px-6 py-8"
      )}>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-[#86b027]/10 blur-[80px] rounded-full pointer-events-none transition-opacity duration-700 opacity-40"></div>
        <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-[#86b027] to-transparent opacity-40"></div>
        <motion.div 
      ...
      {/* Navigation */}
      <div className="flex-1 overflow-y-auto pt-2 pb-6 px-3 space-y-8 relative custom-scrollbar">
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-[#86b027]/5 via-transparent to-[#86b027]/5 opacity-20"></div>
        ...
        <div>
          {!collapsed && (
            <div className="px-3 mb-2 flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold text-slate-200 uppercase tracking-widest">Supply Chain</span>
              <div className="h-px flex-1 bg-gradient-to-l from-white/5 to-transparent"></div>
            </div>
          )}
        ...
        <div>
          {!collapsed && (
            <div className="px-3 mb-2 flex items-center gap-2">
              <div className="h-px flex-1 bg-gradient-to-r from-white/5 to-transparent"></div>
              <span className="text-[10px] font-semibold text-slate-200 uppercase tracking-widest">Sustainability Reporting</span>
              <div className="h-px flex-1 bg-gradient-to-l from-white/5 to-transparent"></div>
            </div>
          )}
          <SidebarItem
        ...
        <div>
          {!collapsed && (
            <div className="px-3 mb-2 flex items-center gap-2">
              <div className="h-px flex-1 bg-gradient-to-r from-white/5 to-transparent"></div>
              <span className="text-[10px] font-semibold text-slate-200 uppercase tracking-widest">Regulatory Compliance</span>
              <div className="h-px flex-1 bg-gradient-to-l from-white/5 to-transparent"></div>
            </div>
          )}
          <SidebarItem
        ...
        <div>
          {!collapsed && (
            <div className="px-3 mb-2 flex items-center gap-2">
              <div className="h-px flex-1 bg-gradient-to-r from-white/5 to-transparent"></div>
              <span className="text-[10px] font-semibold text-slate-200 uppercase tracking-widest">Analytics</span>
              <div className="h-px flex-1 bg-gradient-to-l from-white/5 to-transparent"></div>
            </div>
          )}
          <SidebarItem
          ...
          <SidebarItem
            ...
            path={createPageUrl('BlockchainExplorer')}
            isActive={isActive(createPageUrl('BlockchainExplorer'))}
            collapsed={collapsed} />
        </div>
        ...
        {isAdmin && (
          <div>
            {!collapsed && (
              <div className="px-3 mb-2 flex items-center gap-2">
                <div className="h-px flex-1 bg-gradient-to-r from-white/5 to-transparent"></div>
                <span className="text-[10px] font-semibold text-slate-200 uppercase tracking-widest">System</span>
                <div className="h-px flex-1 bg-gradient-to-l from-white/5 to-transparent"></div>
              </div>
            )}
            <SidebarItem
              ...
              path={createPageUrl('CompanySettings')}
              isActive={isActive(createPageUrl('CompanySettings'))}
              collapsed={collapsed} />
          </div>
        )}
        ...
        {/* Footer */}
        <div className="border-t border-white/10 px-3 pt-4 pb-4 space-y-2">
          ...
          <Button
            variant="ghost"
            className={cn(
              "w-full justify-start text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-all",
